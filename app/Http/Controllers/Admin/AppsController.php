...
use App\Model\Apps As CurrentModel;
...
class AppsController extends Controller
{
	...
	protected $CurrentController = 'apps';
	protected $IndexTitle = 'Apps';
	protected $CreateTitle = 'App';
	protected $EditTitle = 'App';
	protected $EditField = 'app';
