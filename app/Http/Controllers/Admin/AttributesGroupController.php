...
use App\Model\AttributesGroup As CurrentModel;
...
class AttributesGroupController extends Controller
{
	...
	protected $CurrentController = 'attributesgroup';
	protected $IndexTitle = 'Attributes Groups';
	protected $CreateTitle = 'Attributes Group';
	protected $EditTitle = 'Attributes Group';
	protected $EditField = 'attributesgroup';
     ...
     *
     * @param  \App\Model\AttributesGroup  $attributesGroup
     * @return \Illuminate\Http\Response
     */
    public function show(AttributesGroup $attributesGroup)
    {
        //
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, AttributesGroup $attributesGroup)
    {
        //
    }
