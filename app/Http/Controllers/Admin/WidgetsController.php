...
use App\Model\Widgets As CurrentModel;
...
class WidgetsController extends Controller
{
     ...
     */
    protected $CurrentController = 'widgets';
	protected $IndexTitle = 'Widgets';
	protected $CreateTitle = 'Widget';
	protected $EditTitle = 'Widget';
	protected $EditField = 'widget';
    ...
    public function create()
    {
		...
		$fields['left']['default'] = (object) [
				...
				'fields' => [
						...
						['label_text' => 'Description', 'column_name' => 'description', 'type' => 'text', 'input_type' => 'textarea',], //textarea or editor
						['label_text' => 'Type', 'column_name' => 'type', 'type' => 'varchar', 'input_type' => 'select', 'select_data' => ['html' => 'Html', 'latest_article' => 'Latest Article', 'custom_article' => 'Custom Article'], 'validation' => 'required'], 
					],
				];
