...
use App\Model\Templates As CurrentModel;
...
class TemplatesController extends Controller
{
     ...
     */
    protected $CurrentController = 'templates';
	protected $IndexTitle = 'Templates';
	protected $CreateTitle = 'Template';
	protected $EditTitle = 'Template';
	protected $EditField = 'template';
     ...
     public function edit($id)
    {
		...
		/*
		$fields['left']['Widgets'] = (object) [
				'group_prop' => [
					'title' => 'Map Widgets',
					'collapse'	=> 0,
				],
				'fields' => [
						['label_text' => '', 'column_name' => $result['slug'].'_widgets', 'type' => 'blade', 'input_type' => 'multi_entry',
							'fields' => [
								['label_text' => '', 'column_name' => 'multi_data_id', 'type' => 'integer', 'input_type' => 'hidden'],
								['label_text' => 'Widget Title', 'column_name' => 'widget_title', 'type' => 'varchar', 'input_type' => 'text', 'validation' => 'required|no', 'pattern' => '', 'main_field' => true],
								['label_text' => 'Widget', 'column_name' => 'widget_id', 'type' => 'integer', 'input_type' => 'select', 'select_data'=>\App\Model\Widgets::query()->select('id', 'title')->where('published', '=', 1)->pluck('title', 'id')],
							],
						],
				]
