...
use App\Model\PostTypes As CurrentModel;
...
class PostTypesController extends Controller
{
     ...
     */
	protected $CurrentController = 'posttypes';
	protected $IndexTitle = 'Post Types';
	protected $CreateTitle = 'Post Type';
	protected $EditTitle = 'Post Type';
	protected $EditField = 'posttype'; 
     ...
     *
     * @param  \App\Model\PostTypes  $postTypes
     * @return \Illuminate\Http\Response
     */
    public function show(PostTypes $postTypes)
    {
        //
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, PostTypes $postTypes)
    {
        //
    }
