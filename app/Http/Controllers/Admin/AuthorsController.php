...
use App\Model\Authors As CurrentModel;
...
class AuthorsController extends Controller
{
     ...
     */
    protected $CurrentController = 'authors';
	protected $IndexTitle = 'Authors';
	protected $CreateTitle = 'Author';
	protected $EditTitle = 'Author';
	protected $EditField = 'author';
