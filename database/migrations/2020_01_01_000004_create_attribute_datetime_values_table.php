...
class CreateAttributeDateTimeValuesTable extends Migration
{
    ...
    {
        Schema::create(config('hubspot.tables.attribute_datetime_values'), function (Blueprint $table) {
            // Columns
            $table->increments('id');
    ...
    {
        Schema::dropIfExists(config('hubspot.tables.attribute_datetime_values'));
    }
}
